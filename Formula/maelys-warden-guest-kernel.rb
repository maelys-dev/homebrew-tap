...
class MaelysWardenGuestKernel < Formula
  ...
  url "https://github.com/maelys-dev/maelys-warden/releases/download/v0.41.0/maelys-warden-guest-kernel-0.41.0-linux-arm64.tar.gz"
  version "0.41.0"
  sha256 "00018fe639023fb1b3912ea917ef3266bedcbebaf38129b6875653350c7583d6"
